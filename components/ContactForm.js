                            ...
                            <div className="contact__form contact__form-2">
                                ...
                                <div className="contact__form-content">                        
                                    <form action="#" id="contact-form" method="POST">                                    
                                        ...
                                        <div className="field-format d-sm-flex justify-content-between mb-40">
                                            <div className="form-group pr-10 form-group-2">
                                                <input type="text" className="form-control" name="number" placeholder="Phone Number" maxLength={10} minLength={10}/>                                            
                                            </div>
                                            <div className="form-group pr-10 form-group-2">
                                                <input type="number" className="form-control" name="budget" placeholder="Your Budget"/>
                                            </div> 
                                        </div>
